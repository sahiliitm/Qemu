...
sys_env_destroy(envid_t envid)
{
  ...
  80014e:	00 
  80014f:	c7 44 24 08 0f 12 80 	movl   $0x80120f,0x8(%esp)
  800156:	00 
  800157:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80015e:	00 
  80015f:	c7 04 24 2c 12 80 00 	movl   $0x80122c,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  80020d:	00 
  80020e:	c7 44 24 08 0f 12 80 	movl   $0x80120f,0x8(%esp)
  800215:	00 
  800216:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80021d:	00 
  80021e:	c7 04 24 2c 12 80 00 	movl   $0x80122c,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  80026b:	00 
  80026c:	c7 44 24 08 0f 12 80 	movl   $0x80120f,0x8(%esp)
  800273:	00 
  800274:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80027b:	00 
  80027c:	c7 04 24 2c 12 80 00 	movl   $0x80122c,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  8002c9:	00 
  8002ca:	c7 44 24 08 0f 12 80 	movl   $0x80120f,0x8(%esp)
  8002d1:	00 
  8002d2:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8002d9:	00 
  8002da:	c7 04 24 2c 12 80 00 	movl   $0x80122c,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800327:	00 
  800328:	c7 44 24 08 0f 12 80 	movl   $0x80120f,0x8(%esp)
  80032f:	00 
  800330:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800337:	00 
  800338:	c7 04 24 2c 12 80 00 	movl   $0x80122c,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800385:	00 
  800386:	c7 44 24 08 0f 12 80 	movl   $0x80120f,0x8(%esp)
  80038d:	00 
  80038e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800395:	00 
  800396:	c7 04 24 2c 12 80 00 	movl   $0x80122c,(%esp)
...
sys_ipc_try_send(envid_t envid, uint32_t value, void *srcva, int perm)
{
  ...
  8003c8:	8b 7d 14             	mov    0x14(%ebp),%edi
  8003cb:	8b 5d 10             	mov    0x10(%ebp),%ebx
  8003ce:	8b 4d 0c             	mov    0xc(%ebp),%ecx
...
sys_ipc_recv(void *dstva)
{
  ...
  800416:	00 
  800417:	c7 44 24 08 0f 12 80 	movl   $0x80120f,0x8(%esp)
  80041e:	00 
  80041f:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800426:	00 
  800427:	c7 04 24 2c 12 80 00 	movl   $0x80122c,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  80046c:	c7 04 24 3c 12 80 00 	movl   $0x80123c,(%esp)
  ...
  800482:	e8 53 00 00 00       	call   8004da <vcprintf>
	cprintf("\n");
  800487:	c7 04 24 60 12 80 00 	movl   $0x801260,(%esp)
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  800516:	e8 d9 01 00 00       	call   8006f4 <vprintfmt>
	sys_cputs(b.buf, b.idx);
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800626:	0f be 80 62 12 80 00 	movsbl 0x801262(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80084d:	c7 44 24 08 7a 12 80 	movl   $0x80127a,0x8(%esp)
  800854:	00 
  ...
  800870:	c7 44 24 08 83 12 80 	movl   $0x801283,0x8(%esp)
  800877:	00 
  ...
  8008a5:	ba 73 12 80 00       	mov    $0x801273,%edx
