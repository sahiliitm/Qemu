...
sys_env_destroy(envid_t envid)
{
  ...
  800146:	00 
  800147:	c7 44 24 08 ea 11 80 	movl   $0x8011ea,0x8(%esp)
  80014e:	00 
  80014f:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800156:	00 
  800157:	c7 04 24 07 12 80 00 	movl   $0x801207,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800205:	00 
  800206:	c7 44 24 08 ea 11 80 	movl   $0x8011ea,0x8(%esp)
  80020d:	00 
  80020e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800215:	00 
  800216:	c7 04 24 07 12 80 00 	movl   $0x801207,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800263:	00 
  800264:	c7 44 24 08 ea 11 80 	movl   $0x8011ea,0x8(%esp)
  80026b:	00 
  80026c:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800273:	00 
  800274:	c7 04 24 07 12 80 00 	movl   $0x801207,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  8002c1:	00 
  8002c2:	c7 44 24 08 ea 11 80 	movl   $0x8011ea,0x8(%esp)
  8002c9:	00 
  8002ca:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8002d1:	00 
  8002d2:	c7 04 24 07 12 80 00 	movl   $0x801207,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  80031f:	00 
  800320:	c7 44 24 08 ea 11 80 	movl   $0x8011ea,0x8(%esp)
  800327:	00 
  800328:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80032f:	00 
  800330:	c7 04 24 07 12 80 00 	movl   $0x801207,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  80037d:	00 
  80037e:	c7 44 24 08 ea 11 80 	movl   $0x8011ea,0x8(%esp)
  800385:	00 
  800386:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80038d:	00 
  80038e:	c7 04 24 07 12 80 00 	movl   $0x801207,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  80040e:	00 
  80040f:	c7 44 24 08 ea 11 80 	movl   $0x8011ea,0x8(%esp)
  800416:	00 
  800417:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80041e:	00 
  80041f:	c7 04 24 07 12 80 00 	movl   $0x801207,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800464:	c7 04 24 18 12 80 00 	movl   $0x801218,(%esp)
  ...
  80047a:	e8 53 00 00 00       	call   8004d2 <vcprintf>
	cprintf("\n");
  80047f:	c7 04 24 3c 12 80 00 	movl   $0x80123c,(%esp)
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  80050e:	e8 d1 01 00 00       	call   8006e4 <vprintfmt>
	sys_cputs(b.buf, b.idx);
