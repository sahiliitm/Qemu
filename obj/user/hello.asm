...
umain(int argc, char **argv)
{
  ...
  800052:	c7 04 24 0e 12 80 00 	movl   $0x80120e,(%esp)
...
libmain(int argc, char **argv)
{
  ...
  80007c:	e8 ab 0b 00 00       	call   800c2c <sys_getenvid>
...
exit(void)
{
  ...
  8000c9:	e8 01 0b 00 00       	call   800bcf <sys_env_destroy>
}
  8000ce:	c9                   	leave  
  8000cf:	c3                   	ret    
...
putch(int ch, struct printbuf *b)
{
  ...
  8000fd:	e8 6e 0a 00 00       	call   800b70 <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  80014e:	e8 d1 01 00 00       	call   800324 <vprintfmt>
	sys_cputs(b.buf, b.idx);
  ...
  800166:	e8 05 0a 00 00       	call   800b70 <sys_cputs>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800256:	0f be 80 2f 12 80 00 	movsbl 0x80122f(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8003b8:	ff 24 85 00 13 80 00 	jmp    *0x801300(,%eax,4)
		case '6':
		case '7':
		case '8':
		case '9':
  ...
  8004a0:	c7 44 24 08 50 12 80 	movl   $0x801250,0x8(%esp)
  8004a7:	00 
  ...
  8004d5:	ba 40 12 80 00       	mov    $0x801240,%edx
...
sys_env_destroy(envid_t envid)
{
  ...
  800c02:	00 
  800c03:	c7 44 24 08 84 14 80 	movl   $0x801484,0x8(%esp)
  800c0a:	00 
  800c0b:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c12:	00 
  800c13:	c7 04 24 a1 14 80 00 	movl   $0x8014a1,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800cc1:	00 
  800cc2:	c7 44 24 08 84 14 80 	movl   $0x801484,0x8(%esp)
  800cc9:	00 
  800cca:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800cd1:	00 
  800cd2:	c7 04 24 a1 14 80 00 	movl   $0x8014a1,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800d1f:	00 
  800d20:	c7 44 24 08 84 14 80 	movl   $0x801484,0x8(%esp)
  800d27:	00 
  800d28:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d2f:	00 
  800d30:	c7 04 24 a1 14 80 00 	movl   $0x8014a1,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800d7d:	00 
  800d7e:	c7 44 24 08 84 14 80 	movl   $0x801484,0x8(%esp)
  800d85:	00 
  800d86:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d8d:	00 
  800d8e:	c7 04 24 a1 14 80 00 	movl   $0x8014a1,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800ddb:	00 
  800ddc:	c7 44 24 08 84 14 80 	movl   $0x801484,0x8(%esp)
  800de3:	00 
  800de4:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800deb:	00 
  800dec:	c7 04 24 a1 14 80 00 	movl   $0x8014a1,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800e39:	00 
  800e3a:	c7 44 24 08 84 14 80 	movl   $0x801484,0x8(%esp)
  800e41:	00 
  800e42:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e49:	00 
  800e4a:	c7 04 24 a1 14 80 00 	movl   $0x8014a1,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  800eca:	00 
  800ecb:	c7 44 24 08 84 14 80 	movl   $0x801484,0x8(%esp)
  800ed2:	00 
  800ed3:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800eda:	00 
  800edb:	c7 04 24 a1 14 80 00 	movl   $0x8014a1,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800f20:	c7 04 24 b0 14 80 00 	movl   $0x8014b0,(%esp)
  800f27:	e8 47 f2 ff ff       	call   800173 <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800f2c:	89 74 24 04          	mov    %esi,0x4(%esp)
  800f30:	8b 45 10             	mov    0x10(%ebp),%eax
  800f33:	89 04 24             	mov    %eax,(%esp)
  800f36:	e8 d7 f1 ff ff       	call   800112 <vcprintf>
	cprintf("\n");
  800f3b:	c7 04 24 0c 12 80 00 	movl   $0x80120c,(%esp)
  800f42:	e8 2c f2 ff ff       	call   800173 <cprintf>
