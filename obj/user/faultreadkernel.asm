	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800256:	0f be 80 31 12 80 00 	movsbl 0x801231(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80047d:	c7 44 24 08 49 12 80 	movl   $0x801249,0x8(%esp)
  800484:	00 
  ...
  8004a0:	c7 44 24 08 52 12 80 	movl   $0x801252,0x8(%esp)
  8004a7:	00 
  ...
  8004d5:	ba 42 12 80 00       	mov    $0x801242,%edx
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800f36:	e8 cb f1 ff ff       	call   800106 <vcprintf>
	cprintf("\n");
  800f3b:	c7 04 24 d4 14 80 00 	movl   $0x8014d4,(%esp)
