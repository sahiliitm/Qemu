...
sys_env_destroy(envid_t envid)
{
  ...
  80013e:	00 
  80013f:	c7 44 24 08 ea 11 80 	movl   $0x8011ea,0x8(%esp)
  800146:	00 
  800147:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80014e:	00 
  80014f:	c7 04 24 07 12 80 00 	movl   $0x801207,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  8001fd:	00 
  8001fe:	c7 44 24 08 ea 11 80 	movl   $0x8011ea,0x8(%esp)
  800205:	00 
  800206:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80020d:	00 
  80020e:	c7 04 24 07 12 80 00 	movl   $0x801207,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  80025b:	00 
  80025c:	c7 44 24 08 ea 11 80 	movl   $0x8011ea,0x8(%esp)
  800263:	00 
  800264:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80026b:	00 
  80026c:	c7 04 24 07 12 80 00 	movl   $0x801207,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  8002b9:	00 
  8002ba:	c7 44 24 08 ea 11 80 	movl   $0x8011ea,0x8(%esp)
  8002c1:	00 
  8002c2:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8002c9:	00 
  8002ca:	c7 04 24 07 12 80 00 	movl   $0x801207,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800317:	00 
  800318:	c7 44 24 08 ea 11 80 	movl   $0x8011ea,0x8(%esp)
  80031f:	00 
  800320:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800327:	00 
  800328:	c7 04 24 07 12 80 00 	movl   $0x801207,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800375:	00 
  800376:	c7 44 24 08 ea 11 80 	movl   $0x8011ea,0x8(%esp)
  80037d:	00 
  80037e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800385:	00 
  800386:	c7 04 24 07 12 80 00 	movl   $0x801207,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  800406:	00 
  800407:	c7 44 24 08 ea 11 80 	movl   $0x8011ea,0x8(%esp)
  80040e:	00 
  80040f:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800416:	00 
  800417:	c7 04 24 07 12 80 00 	movl   $0x801207,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800435:	83 ec 20             	sub    $0x20,%esp
	...
	va_start(ap, fmt);
  800438:	8d 75 14             	lea    0x14(%ebp),%esi
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  800506:	e8 d9 01 00 00       	call   8006e4 <vprintfmt>
	sys_cputs(b.buf, b.idx);
