...
sys_env_destroy(envid_t envid)
{
  ...
  800156:	00 
  800157:	c7 44 24 08 18 12 80 	movl   $0x801218,0x8(%esp)
  80015e:	00 
  80015f:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800166:	00 
  800167:	c7 04 24 35 12 80 00 	movl   $0x801235,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800215:	00 
  800216:	c7 44 24 08 18 12 80 	movl   $0x801218,0x8(%esp)
  80021d:	00 
  80021e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800225:	00 
  800226:	c7 04 24 35 12 80 00 	movl   $0x801235,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800273:	00 
  800274:	c7 44 24 08 18 12 80 	movl   $0x801218,0x8(%esp)
  80027b:	00 
  80027c:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800283:	00 
  800284:	c7 04 24 35 12 80 00 	movl   $0x801235,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  8002d1:	00 
  8002d2:	c7 44 24 08 18 12 80 	movl   $0x801218,0x8(%esp)
  8002d9:	00 
  8002da:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8002e1:	00 
  8002e2:	c7 04 24 35 12 80 00 	movl   $0x801235,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  80032f:	00 
  800330:	c7 44 24 08 18 12 80 	movl   $0x801218,0x8(%esp)
  800337:	00 
  800338:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80033f:	00 
  800340:	c7 04 24 35 12 80 00 	movl   $0x801235,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  80038d:	00 
  80038e:	c7 44 24 08 18 12 80 	movl   $0x801218,0x8(%esp)
  800395:	00 
  800396:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80039d:	00 
  80039e:	c7 04 24 35 12 80 00 	movl   $0x801235,(%esp)
...
sys_ipc_try_send(envid_t envid, uint32_t value, void *srcva, int perm)
{
  ...
  8003d0:	8b 7d 14             	mov    0x14(%ebp),%edi
...
sys_ipc_recv(void *dstva)
{
  ...
  80041e:	00 
  80041f:	c7 44 24 08 18 12 80 	movl   $0x801218,0x8(%esp)
  800426:	00 
  800427:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80042e:	00 
  80042f:	c7 04 24 35 12 80 00 	movl   $0x801235,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800453:	8b 1d 04 20 80 00    	mov    0x802004,%ebx
  ...
  800474:	c7 04 24 44 12 80 00 	movl   $0x801244,(%esp)
  ...
  80048a:	e8 53 00 00 00       	call   8004e2 <vcprintf>
	cprintf("\n");
  80048f:	c7 04 24 0c 12 80 00 	movl   $0x80120c,(%esp)
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  80051e:	e8 d1 01 00 00       	call   8006f4 <vprintfmt>
	sys_cputs(b.buf, b.idx);
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800626:	0f be 80 68 12 80 00 	movsbl 0x801268(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80084d:	c7 44 24 08 80 12 80 	movl   $0x801280,0x8(%esp)
  800854:	00 
  ...
  800870:	c7 44 24 08 89 12 80 	movl   $0x801289,0x8(%esp)
  800877:	00 
  ...
  8008a5:	ba 79 12 80 00       	mov    $0x801279,%edx
